...
assertSameValue([
    ['pc_id' => 'worker-a', 'mac' => 'aa:bb:cc:dd:ee:ff', 'soc_margin_percent' => 7, 'wake_enabled' => false],
    ['pc_id' => 'worker-b', 'mac' => '11:22:33:44:55:66', 'soc_margin_percent' => 5, 'wake_enabled' => true],
], $machines, 'Machine-list parser should preserve dashboard behavior.');
assertSameValue(
    "worker-a,aa:bb:cc:dd:ee:ff,7,0\nworker-b,11:22:33:44:55:66,5,1",
